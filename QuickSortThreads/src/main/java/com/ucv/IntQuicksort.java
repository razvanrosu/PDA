...
import static com.ucv.Util.median;
import static com.ucv.Util.swap;
...
public class IntQuicksort {
    ...
    public static void main(String[] args) {
        ...
        int[] array1 = getRandomArray(SIZE, 0, 100, random);
...
//        }
        ...
        System.out.printf("com.ucv.IntQuicksort.sort in %.2f milliseconds.\n",
        ...
        System.out.printf("com.ucv.ParallelIntQuicksort.sort in %.2f milliseconds.\n",
                (endTime - startTime) / 1e6);
